...
public class SymbolicSubdivisionBuilder {
    ...
    public SymbolicPolygonMesh subdivide() {
        ...
        return new SymbolicPolygonMesh(points, texCoords, faces, faceSmoothingGroups);
    }
    ...
    private int calcControlPoint(int srcPointIndex) {
        ...
        return points.addControlPoint(facePoints, edgePoints, fromEdgePoints, toEdgePoints, isEdgeBoundary, srcPointIndex, pointInfo.isBoundary(), pointInfo.hasInternalEdge());
    }
